...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBAction func didTapTest(_ sender: Any) { // probaly i don't need it
...
//        userNotification()
//        notificationContenet()
        
//        table.delegate = self
//        table.dataSourcen = self
    }
    ...
    func userNotification(){
        ...
        center.requestAuthorization(options: [.alert, .badge, .sound ]) {
            ...
            if granted {
                // schadule test
                self.notificationContenet() // i might only used the one in didload only
            }
            else if error != nil{
